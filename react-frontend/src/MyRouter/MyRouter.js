...
import SignUpPage from '../components/app_components/SignUp/SignUpPage';
import AppTopbar from '../components/app_components/Layouts/AppTopbar';
//  ~cb-add-import~
...
const MyRouter = (props) => {
    return (
        <Routes>
            ...
            <Route path="/" exact element={props.isLoggedIn ? <LandingPage /> : <LoginPage />} />
            <Route path="/login" exact element={props.isLoggedIn === true ? <LandingPage /> : <LoginPage />} />
