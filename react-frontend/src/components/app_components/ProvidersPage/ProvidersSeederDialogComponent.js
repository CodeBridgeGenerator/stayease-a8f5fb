...
import seederData from "./providers.seeder.json";
...
const ProvidersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProvidersSeederDialogComponent);
