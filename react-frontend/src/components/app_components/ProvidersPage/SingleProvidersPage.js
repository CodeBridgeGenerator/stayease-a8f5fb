...
const SingleProvidersPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("providers")
            .get(urlParams.singleProvidersId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleProvidersId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>providers/{urlParams.singleProvidersId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">PriceRange</label><p className="m-0 ml-3" >{_entity?.priceRange}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">WhatsappLink</label><p className="m-0 ml-3" >{_entity?.whatsappLink}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">ImageUrl</label><p className="m-0 ml-3" >{_entity?.imageUrl}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleProvidersId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleProvidersPage);
