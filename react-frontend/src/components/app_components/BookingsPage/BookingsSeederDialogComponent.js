...
import seederData from "./bookings.seeder.json";
...
const BookingsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(BookingsSeederDialogComponent);
