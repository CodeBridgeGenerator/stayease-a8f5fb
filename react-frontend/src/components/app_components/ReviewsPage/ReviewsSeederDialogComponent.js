...
import seederData from "./reviews.seeder.json";
...
const ReviewsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ReviewsSeederDialogComponent);
