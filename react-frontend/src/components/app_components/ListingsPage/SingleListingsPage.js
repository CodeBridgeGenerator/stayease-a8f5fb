...
const SingleListingsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("listings")
            .get(urlParams.singleListingsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleListingsId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>listings/{urlParams.singleListingsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">ImageUrl</label><p className="m-0 ml-3" >{_entity?.imageUrl}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleListingsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleListingsPage);
