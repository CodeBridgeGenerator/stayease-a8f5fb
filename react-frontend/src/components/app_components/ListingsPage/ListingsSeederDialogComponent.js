...
import seederData from "./listings.seeder.json";
...
const ListingsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ListingsSeederDialogComponent);
